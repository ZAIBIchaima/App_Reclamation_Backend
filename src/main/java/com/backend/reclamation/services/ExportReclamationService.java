...
public class ExportReclamationService {
	...
	public ByteArrayInputStream reclamationPdf(List<Reclamation> reclamations) throws MalformedURLException, IOException {
